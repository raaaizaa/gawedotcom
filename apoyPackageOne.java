 ...
 * @author Diandra Jade
 */
public class apoyPackageOne extends javax.swing.JFrame {
    public apoyPackageOne() {
        initComponents();
        setSize(380, 770);
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\Raiza Rahman\\OneDrive - Bina Nusantara University\\Documents\\SUNIB\\2022-2023\\Object Oriented Programming\\gawedotcomui\\wawawawawawa\\image 7.png")); // NOI18N
        ...
        jLabel3.setText("PRICE : IDR 7.500.000");
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        freelancerDetailApoy apoy = new freelancerDetailApoy();
        apoy.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new apoyPackageOne().setVisible(true);
            }
        });
    }
