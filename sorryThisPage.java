 ...
 * @author Raiza Rahman
 */
public class sorryThisPage extends javax.swing.JFrame {

    public sorryThisPage() {
        initComponents();
        setSize(380, 770);
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        freelancertop.setFont(new java.awt.Font("Casual", 0, 14)); // NOI18N
        ...
        freelancertop.setText("Sorry this page currently is not available");
    ...
    // Balik lagi ke frame login page
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sorryThisPage().setVisible(true);
            }
        });
    }
